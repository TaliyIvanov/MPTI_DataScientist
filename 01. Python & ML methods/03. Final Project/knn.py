...
class KNN:
    ...
    def predict_labels_binary(self, dists):
        ...
        for i in range(num_test):
            ...
            # Count the number of positive and negative labels among the nearest neighbors
            positive_count = np.sum(nearest_labels)
    ...
    def predict_labels_multiclass(self, dists):
        ...
        for i in range(num_test):
            ...
            class_counts = np.bincount(nearest_labels, minlength=self.train_y.max() + 1)
